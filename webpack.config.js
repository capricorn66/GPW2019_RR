...
const htmlDictionary = generateHtml('dictionary');
const htmlLetter = generateHtml('letter');
const htmlQuestionnaire = generateHtml('questionnaire');
const htmlCapitals = generateHtml('capitals');
const htmlInteractiveKPI = generateHtml('InteractiveKPI');
...
module.exports = (env, options) => {
    ...
    return {
        ...
        plugins: [
            ...
            .concat(htmlIndex)
            .concat(htmlDictionary)
            .concat(htmlServer)
            .concat(htmlLetter)
            .concat(htmlQuestionnaire)
            .concat(htmlCapitals)
